...
const YourProjectsBody = () => {
  ...
  if (projects.length === 0) {
    return (
      <div className="hidden tablet:grid bg-lightbgprimary dark:bg-darkbgprimary rounded-lg p-3 shadow-lg items-center justify-items-center gap-3 transition-all duration-500">
        <div
          onClick={() => setShowCrateProject(true)}
          className=" text-white bg-lightbuttonprimary hover:bg-lightbuttonhoverprimary focus:ring-2 focus:outline-none focus:ring-lightbuttonringprimary  dark:bg-darkbuttonprimary dark:hover:bg-darkbuttonhoverprimary dark:focus:ring-darkbuttonringprimary flex cursor-pointer w-full  py-3 rounded duration-500 justify-center items-center transition-all "
        >
  ...
  /*  if (getProjects.loading)
    return (
      <div className="hidden tablet:grid bg-lightbgprimary dark:bg-darkbgprimary rounded-lg p-3 shadow-lg justify-center gap-3 transition-all duration-500 align-center">
        <svg
          aria-hidden="true"
          role="status"
    ...
    <div>
      {expandedYourProjectsBody ? (
        <div
          ...
          className="hidden tablet:grid bg-lightbgprimary dark:bg-darkbgprimary rounded-lg px-3 pt-3 shadow-lg justify-items-center items-center gap-3 transition-all duration-500"
        >
          {/*  <img
          ...
          <div
            onClick={() => setShowCrateProject(true)}
            className=" text-white bg-lightbuttonprimary hover:bg-lightbuttonhoverprimary focus:ring-2 focus:outline-none focus:ring-lightbuttonringprimary  dark:bg-darkbuttonprimary dark:hover:bg-darkbuttonhoverprimary dark:focus:ring-darkbuttonringprimary flex cursor-pointer w-full py-5 rounded duration-500 justify-center items-center transition-all"
          >
            <span className="text-lg tablet:text-2xl">+</span>
          </div>
        ...
        <div
          onMouseEnter={() => setExpandedYourProjectsBody(true)}
          onMouseLeave={() => setExpandedYourProjectsBody(false)}
          className="hidden tablet:grid bg-lightbgprimary dark:bg-darkbgprimary rounded-lg px-2 pt-3 shadow-lg items-center justify-items-center gap-3 transition-all duration-500"
        >
          {projects.map((project) => (
            <div
              key={project.id}
