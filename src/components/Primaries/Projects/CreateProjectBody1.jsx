  ...
  return (
    <div className="fixed inset-0">
      <div className="modal-flex-container flex items-center justify-center min-h-screen text-center">
        <div className="modal-bg-container fixed inset-0 bg-[#242424] bg-opacity-75"></div>
        <div className="modal-container  mb-16 tablet:mb-0 inline-block align-bottom bg-[#1a1a1a] rounded-lg overflow-hidden shadow-lg transform transition-all">
        <ButtonBack textButton={"<"} onClick={onClose} />
          <div className="modal-wrapper bg-[#1a1a1a] p-10">
