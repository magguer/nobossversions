...
const FormInputsText = forwardRef(
  ({ type, placeholder, onChange, onBlur, name, error, children }, ref) => {
    ...
    const inputStyleDefault = "bg-lightbgsecondary placeholder:text-textsecundary dark:bg-darkbgsecondary border border-gray-800 dark:border-[#1a1a1a] text-white dark:text-white text-sm rounded-lg focus:ring-[#1e1e1e] focus:border-gray-300 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
